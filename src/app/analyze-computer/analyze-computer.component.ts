...
@Component({
  selector: 'app-analyze-computer',
  templateUrl: './analyze-computer.component.html',
  styleUrls: ['./analyze-computer.component.scss']
})
export class AnalyzeComputerComponent implements OnInit {
  puntoVendita:any;
  ...
  private _filter(value: string): string[] {
    this.sceltaComputer=this.options.indexOf(value);
