...
export class ExploreComponent implements OnInit {
  computerList:Computer[] = [
    ...
    new Computer(2,'CA41B','Asus',350,'Laptop',2,'Intel i3 10th',4,'128','Iris','/',"https://gizchina.it/wp-content/uploads/2020/11/Recensione-Asus-Rog-G14-gaming-pc-notebook-portatile-prezzo-prestazioni-fotocamera-display-italia-test-software-benchmark-fps-games-details-3-scaled.jpg"),
